        ...
        for j in range(0, w - mbSize + 1, mbSize):
            ...
            if costs[4] != 0:
                ...
                for k in range(9):
                    ...
                    if k == 4:
                        continue
                    costs[k] = costMAD(imgP[i:i + mbSize, j:j + mbSize], imgI[refBlkVer:refBlkVer + mbSize, refBlkHor:refBlkHor + mbSize])
                    computations += 1
                ...
                if cornerFlag == 1:
                    ...
                    for idx in lst:
                        ...
                        if not checkBounded(refBlkHor, refBlkVer, w, h, mbSize):
                            ...
                            costs[idx] = costMAD(imgP[i:i + mbSize, j:j + mbSize], imgI[refBlkVer:refBlkVer + mbSize, refBlkHor:refBlkHor + mbSize])
                            computations += 1
                ...
                for m in range(-stepSize, stepSize+1, stepSize):
                    for n in range(-stepSize, stepSize+1, stepSize):
                        ...
                        if ((costRow == 1) and (costCol == 1)):
                            continue
                        costs[costRow, costCol] = costMAD(imgP[i:i + mbSize, j:j + mbSize], imgI[refBlkVer:refBlkVer + mbSize, refBlkHor:refBlkHor + mbSize])
